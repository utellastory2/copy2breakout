...
int main(void)
{
        ...
        // TODO while loop
    {
        ...
        // printf("line 238 check for edge collisions");
        // printf("line 239 y_velocity = %f\n", y_velocity);
        // checking for collision with edges of widow
        // printf("\nbegin step 4\n");
        ...
        { 
            // we've hit the top 
            y_velocity = -y_velocity;
            printf("line 300 check for TOP edge collisions");
        }
        // pause(10);
            ...
            // printf("line num 343  y_velocity = %f\n", y_velocity);
            // printf("after leaving bracket 344 on line 342\n\n\n");
    }
    // Leaving while loop
